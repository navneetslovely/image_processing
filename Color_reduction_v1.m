...
Cb_star(1:2:end,1:2:end)=Cb_m;  %%%%%
Cb_star(1:2:end,2:2:end)=Cb_m;
Cb_star(2:2:end,1:2:end)=Cb_m;
Cb_star(2:2:end,2:2:end)=Cb_m;

Cr_star=zeros(512,512);

Cr_star(1:2:end,1:2:end)=Cr_m;  %%%%%
Cr_star(1:2:end,2:2:end)=Cr_m;
Cr_star(2:2:end,1:2:end)=Cr_m;
Cr_star(2:2:end,2:2:end)=Cr_m;
